...
def _register_handlers(dp: Dispatcher) -> None:
    ...
    async def start(message: Message) -> None:
        await message.answer(
            ...
            "/monthfm — extrato mensal do Last.fm\n"
            "/weekfm — extrato semanal do Last.fm\n"
    ...
    async def help_command(message: Message) -> None:
        await message.answer(
            ...
            "◌ /monthfm\n"
            "Mostra seu extrato mensal do Last.fm. Use /monthfm, /monthfm 05 ou /monthfm 2026-05.\n\n"
            "◌ /weekfm\n"
            "Mostra seu extrato semanal do Last.fm. Use /weekfm, /weekfm 2026-05-06 ou /weekfm 2026-05-06 2026-05-13.\n\n"
            "★ /myself\n"
