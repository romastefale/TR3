...
def _register_handlers(dp: Dispatcher) -> None:
    ...
    async def start(message: Message) -> None:
        await message.answer(
            ...
            "Tocando agora:\n"
            "/playing — sua música atual (capa + nome)\n"
            "/albnow — álbum da música atual\n"
            "/tcanvas — Spotify Canvas (vídeo curto vertical)\n"
            "/tnow — mosaico ao vivo do grupo\n\n"
            "Extratos Last.fm:\n"
            "/myself — seu extrato (botão Semanal | Mensal)\n"
            "/weekfm — extrato semanal direto\n"
            "/monthfm — extrato mensal direto\n"
            "/songcharts — ranking do grupo (top 10, só admin)\n\n"
            "Interação:\n"
    ...
    async def help_command(message: Message) -> None:
        await message.answer(
            ...
            "— TOCANDO AGORA —\n\n"
            "♫ /playing\n"
            "Mostra a música que você está ouvindo agora (ou a última registrada) com capa do álbum.\n\n"
            "◐ /albnow\n"
            "Mostra o álbum da música atual com capa e info.\n\n"
            "▶ /tcanvas\n"
            "Manda o Spotify Canvas (vídeo curto vertical) da sua música atual. Sem Canvas, cai pra capa.\n\n"
            "◉ /tnow\n"
            "Mosaico ao vivo de quem tá ouvindo o quê no grupo agora. Em DM (owner) agrega todos os conectados.\n\n"
            "— EXTRATOS LAST.FM —\n\n"
            "★ /myself\n"
            "Porta de entrada do seu extrato pessoal: botão verde <b>Semanal</b> ou vermelho <b>Mensal</b>. "
            "Gera o mesmo card visual de /weekfm e /monthfm.\n\n"
            "◌ /weekfm\n"
            "Seu extrato semanal do Last.fm com card visual (top 5 artistas e músicas + minutos ouvidos). "
            "Use /weekfm, /weekfm 2026-05-06 ou /weekfm 2026-05-06 2026-05-13.\n\n"
            "◌ /monthfm\n"
            "Seu extrato mensal do Last.fm com card visual. Use /monthfm, /monthfm 05 ou /monthfm 2026-05.\n\n"
            "≡ /songcharts\n"
            "Ranking do grupo agregando todos os Last.fm conectados — card com <b>top 10</b> artistas e músicas, "
            "post fixado automaticamente. Em grupo: só admin. Em DM (owner): ranking global.\n\n"
            "— INTERAÇÃO —\n\n"
            "☻ /mood &lt;0-10&gt;\n"
